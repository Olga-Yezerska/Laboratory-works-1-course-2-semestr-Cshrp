...
public class Department
{
    ...
    public int yearLoad; //річне навантаження
    ...
    /// <summary>
    /// Вдастивість для асоціації між кафедрою та факультетом
    /// </summary>
    ...
    /// <summary>
    /// Властивість для асоціації між кафедрою та IT-компанією
    /// </summary>
    ...
    public Department(string departmentName, string specialization, string departmentHead, int numberOfTeachers, string[] disciplines, string[] lecturers, string[] lecturerSpecializations, int[] disciplineHours, string[] disciplineLecturers, int yearLoad)  //конструктор з параметрами
    {
        this.departmentName = departmentName;
        this.yearLoad = yearLoad; //річне навантаження
    ...
    /// <summary>
    /// Додавання викладачів кафедр
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    /// <returns> результат додавання </returns>
    public static Department operator +(Department obj1, Department obj2)
    {
        Department department = new Department()
        {
            departmentName = obj1.departmentName,
            specialization = obj1.specialization,
            departmentHead = obj1.departmentHead,
            numberOfTeachers = obj1.numberOfTeachers + obj2.numberOfTeachers, //додавання кількості викладачів
            disciplines = obj1.disciplines,
            lecturers = obj1.lecturers,
            lecturerSpecializations = obj1.lecturerSpecializations,
            disciplineHours = obj1.disciplineHours,
            disciplineLecturers = obj1.disciplineLecturers
        }; //створення нового об'єкту
        return department; //повернення нового об'єкту
    }
    /// <summary>
    /// Віднімання викладачів кафедр
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    ...
    public static Department operator -(Department obj1, Department obj2)
    {
        Department department = new Department()
        {
            ...
            specialization = obj1.specialization,
            departmentHead = obj1.departmentHead,
            numberOfTeachers = obj1.numberOfTeachers - obj2.numberOfTeachers, //віднімання кількості викладачів
            disciplines = obj1.disciplines,
            lecturers = obj1.lecturers,
            lecturerSpecializations = obj1.lecturerSpecializations,
            disciplineHours = obj1.disciplineHours,
    ...
    /// <summary>
    /// Порівнянна на більшість викладчів
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    ...
    {
        return obj1.numberOfTeachers > obj2.numberOfTeachers; //результат порівняння
    }
    /// <summary>
    /// Порівняння на меншість викладчів
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    /// <returns> результат порівняння </returns>
    ...
    /// <summary>
    /// Порівняння на рівність викладчів
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    /// <returns> результат порівняння </returns>
    public static bool operator ==(Department obj1, Department obj2)
    {
        //якщо обидва об'єкти однакові
        if (ReferenceEquals(obj1, obj2))
        {
            return true;
        }
        //якщо один з об'єктів null
        if (obj1 is null || obj2 is null)
        {
            return false;
        }
        if (obj1.numberOfTeachers != obj2.numberOfTeachers) //якщо кількість викладачів не однакова
        {
            return false;
        }
        return (obj1.departmentName == obj2.departmentName && obj1.specialization == obj2.specialization && obj1.departmentHead == obj2.departmentHead && obj1.disciplines == obj2.disciplines && obj1.lecturers == obj2.lecturers && obj1.lecturerSpecializations == obj2.lecturerSpecializations && obj1.disciplineHours == obj2.disciplineHours && obj1.disciplineLecturers == obj2.disciplineLecturers); //порівняння об'єктів
    }
    /// <summary>
    /// Порівняння на нерівність викладчів
    /// </summary>
    /// <param name="obj1"> перший об'єкт </param>
    /// <param name="obj2"> другий об'єкт </param>
    /// <returns> результат порівняння </returns>
    ...
    {
        //перевірка на null та тип об'єкта
        if (obj == null || GetType() != obj.GetType())
        {
            return false;
        }
        Department other = (Department)obj; //приведення типу
        return this.numberOfTeachers == other.numberOfTeachers; //порівняння кількості викладачів
    }
    /// <summary>
    ...
    {
        return numberOfTeachers.GetHashCode(); //хеш-код для кількості викладачів
    }
    /// <summary>
    /// Інкрементування кількості викладачів кафедри
    /// </summary>
    /// <param name="v"> об'єкт, який інкрементуємо </param>
    /// <returns> результат інкрементації </returns>
    public static Department operator ++(Department v)
    {
        return new Department
        {
            departmentName = v.departmentName,
            specialization = v.specialization,
            departmentHead = v.departmentHead,
            numberOfTeachers = v.numberOfTeachers + 1,
            disciplines = v.disciplines,
            lecturers = v.lecturers,
            lecturerSpecializations = v.lecturerSpecializations,
            disciplineHours = v.disciplineHours,
            disciplineLecturers = v.disciplineLecturers
        };
    }
    /// <summary>
    /// Декрементування кількості викладачів кафедри
    /// </summary>
    ...
    public void CreateCurriculum(string output)
    {
        service.Data = $"=== Curriculum for {departmentName}===\n";
        service.Data += "Faculty Load: 7200 hours\n";
        service.Data += output;
        service.Data += $"\nCurriculum Approved by\nDepartment Head: {departmentHead}\nFaculty Dean: {Faculty.FacultyDean}";
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver3\curriculum.txt";
        service.WriteData();
    }
    /// <summary>
    /// Метод запису результатів поліморфізму
    /// </summary>
    /// <param name="operationType"> тип операції </param>
    /// <param name="details"> деталі та результати</param>
    public void LogOperation(string operationType, string details)
    {
        string filePath = $@"D:\Новая папка\C#\Lab5Ver3\operations_Department.txt";
        string logEntry = $"\n=== Operation Log ===\n";
        logEntry += $"Operation: {operationType}\n";
        logEntry += $"Details:\n{details}\n";
        string existingData = "";
