...
class Program
{
    ...
    {
        Console.WriteLine("\nStudent Olha Yezerska, SE-12(4), lab 5, var 4, ver 3");
    ...
    static void Main(string[] args)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver3\setup_data.txt";
        service.WriteData();
        ...
        //Створення об'єкту класу SetOfDepartments
        SetOfDepartments set = new SetOfDepartments(3);
        set[0] = new Department { DepartmentName = "DeptA", NumberOfTeachers = 5, yearLoad = 7200, service = new Service() }; //створення об'єкту класу Department
        set[1] = new Department { DepartmentName = "DeptB", NumberOfTeachers = 7, yearLoad = 3600, service = new Service() }; //створення об'єкту класу Department
        set[2] = new Department { DepartmentName = "DeptC", NumberOfTeachers = 3, yearLoad = 5400, service = new Service() }; //створення об'єкту класу Department

        //створення копії кафедри з індексу 1
        Department copiedDept = new Department(set[1]);
        service.PrintData($"\nCopied Department from DeptB: Name = {copiedDept.DepartmentName}, Teachers = {copiedDept.NumberOfTeachers}, YearLoad = {copiedDept.yearLoad}\n");

        Department department1 = set[1]; //перевірити
        service.PrintData($"Department1: Name = {department1.DepartmentName}, Teachers = {department1.NumberOfTeachers}, YearLoad = {department1.yearLoad}\n");
