...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        department.CreateCurriculum(output, faculty.FacultyDean); //виклик методу створення навчального плану кафедри

        //Завершення програми
        service.PrintData("All data is written to files!");
        service.PrintData("\n=== End of program ===\n");
    }
}