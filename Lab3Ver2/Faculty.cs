...
public class Faculty
{
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver2\partnership_request.txt";
    ...
    public void PrepareResponse(string companyName, string activityField, string[] directions)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver2\partnership_response.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void ApproveStudyLoadAndDirections()
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver2\approved_study_load_and_directions.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void FormulateConclusion(string conclusion, double disciplineQuality, double teacherQualification, double provisionQuality, double studentMotivation)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver2\quality_conclusion.txt";
        service.WriteData();
    }
}