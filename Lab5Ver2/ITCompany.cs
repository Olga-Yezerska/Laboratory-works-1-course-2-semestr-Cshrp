...
public class ITCompany : OrganizationalStructure
{
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver2\setup_data.txt"; //шлях до файлу
    ...
    public void CreateRequest(string interactionFormat, string[] directions, string benefits)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver2\partnership_request.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void SignAgreement(double score)
    {
        ...
        {
            service.PrintData("\nAgreement is signed!\n");
            service.PathToFile = @"D:\Новая папка\C#\Lab5Ver2\partnership_response.txt";
    ...
    public void ProvideRecommendations(double fact, double minimum, double norm)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver2\recommendations.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    {
        string partnershipActPath = @"D:\Новая папка\C#\Lab5Ver2\partnership_act.txt";
    ...
    public void CreateDepartment(string facultyName)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5Ver2\department.txt";
        service.WriteData();
    }
}