using System;
public class Faculty : OrganizationalStructure, IComparable
{
    ...
    /// <param name="teacherCount">кількість викладачів</param>
    public Faculty(string structureName, string activityDirection, double processQuality, string partnerStructure, string[] directions, string facultyDean, int departmentNumber, int studyLoad, int[] departmentLoad, double score, int teacherCount) : base(structureName, activityDirection, processQuality, partnerStructure, directions)
    {
    ...
    /// <summary>
    /// Властивість кількості викладачів
    /// </summary>
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab4Ver4\partnership_request.txt"; //шлях до файлу 
    ...
    public void ApproveDirections()
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab4Ver4\approved_areas.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void ApproveStudyLoad()
    {
        ...
        service.Data += $"Approved by dean {facultyDean}.";
        service.PathToFile = @"D:\Новая папка\C#\Lab4Ver4\approved_study_load.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void FormulateConclusion(string conclusion, double disciplineQuality, double teacherQualification, double provisionQuality, double studentMotivation)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab4Ver4\quality_conclusion.txt";
        service.WriteData();
    }
    /// <summary>
    /// Метод для порівняння факультетів
    /// </summary>
    ...
    int IComparable.CompareTo(object obj)
    {
        ...
        return String.Compare(this.structureName, other.structureName);
    }
}