...
public class Faculty : OrganizationalStructure
{
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab5\partnership_request.txt"; //шлях до файлу 
    ...
    public void ApproveDirections()
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5\approved_areas.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void ApproveStudyLoad()
    {
        ...
        service.Data += $"Approved by dean {facultyDean}.";
        service.PathToFile = @"D:\Новая папка\C#\Lab5\approved_study_load.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void FormulateConclusion(string conclusion, double disciplineQuality, double teacherQualification, double provisionQuality, double studentMotivation)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab5\quality_conclusion.txt";
        service.WriteData();
    }
    /// <summary>
