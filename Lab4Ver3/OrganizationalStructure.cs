using System;
public class OrganizationalStructure : IOrganizationalStructure
{
    ...
    {
        string partnershipActPath = @"D:\Новая папка\C#\Lab4Ver3\partnership_act.txt"; //шлях до файлу
    ...
    {
        string filePath = $@"D:\Новая папка\C#\Lab4Ver3\update_{structureName}.txt"; //шлях до файлу
