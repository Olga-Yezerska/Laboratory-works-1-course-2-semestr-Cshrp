...
public class ITCompany : OrganizationalStructure
{
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab4\setup_data.txt"; //шлях до файлу
    ...
    public void CreateRequest(string interactionFormat, string[] directions, string benefits)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab4\partnership_request.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void ProvideRecommendations(double fact, double minimum, double norm)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab4\recommendations.txt";
        service.WriteData();
    }
}