...
public class Faculty
{
    ...
    {
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver4\partnership_request.txt";
        string setupData = service.ReadFromFile().ToLower(); //зчитування даних з файлу
        string[] keywords = { "cyber security", "technologies", "department", "preparation", "great", "interships", "threats", "create", "new" }; //ключові слова для оцінки пропозиції
    ...
    public void PrepareResponse(string companyName, string activityField, string[] directions)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver4\partnership_response.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    /// </summary>
    public void ApproveStudyLoadAndDirections()
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver4\approved_study_load_and_directions.txt";
        service.WriteData();
    }
    /// <summary>
    ...
    public void FormulateConclusion(string conclusion, double disciplineQuality, double teacherQualification, double provisionQuality, double studentMotivation)
    {
        ...
        service.PathToFile = @"D:\Новая папка\C#\Lab3Ver4\quality_conclusion.txt";
        service.WriteData();
    }
}